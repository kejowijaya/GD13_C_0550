package com.example.gd11_c_0550
...
import com.example.gd11_c_0550.adapters.MahasiswaAdapter
import com.example.gd11_c_0550.api.MahasiswaApi
import com.example.gd11_c_0550.models.Mahasiswa
...
class MainActivity : AppCompatActivity() {
    ...
    private var svMahasiwa: SearchView? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        svMahasiwa = findViewById(R.id.sv_mahasiswa)

        srMahasiswa?.setOnRefreshListener (SwipeRefreshLayout.OnRefreshListener { allMahasiswa() })
        svMahasiwa?.setOnQueryTextListener(object : SearchView.OnQueryTextListener{
    ...
    private fun allMahasiswa(){
        ...
        val stringRequest : StringRequest = object:
            StringRequest(Method.GET, MahasiswaApi.GET_ALL_URL, Response.Listener { response ->
                ...
                adapter!!.filter.filter(svMahasiwa!!.query)
